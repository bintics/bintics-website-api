...
@section('content')
	...
	{!! Form::open(['route' => ['admin.courses.edit', $course->id]]) !!}
		...
		<div class="col-md-6">
			...
			{!! Form::textarea('short_description', $course->short_description, ['class' => 'form-control', 'id' => 'short_description']) !!}

			<label for="long_description">{!! trans('admin.courses.field.long_description') !!}</label>
			{!! Form::textarea('long_description', $course->long_description, ['class' => 'form-control', 'id' => 'long_description']) !!}
